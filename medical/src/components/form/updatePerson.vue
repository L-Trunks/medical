    ...
    export default {
        ...
        methods: {
            init(){
                ...
                this.$post('http://localhost:4000/getFamilyDetail',qs.stringify(this.info)).then(res => {
            ...
            onSubmit(){
                ...
                this.$refs.form.validate((valid) => {
                    if(valid) {
                        this.$post('http://localhost:4000/updateFamilyDetail',qs.stringify(this.form)).then(res => {
