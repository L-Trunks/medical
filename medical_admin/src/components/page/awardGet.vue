<template>
  <div>
    ...
    >
      <el-table-column fixed prop="l_drawtime" label="领取时间" sortable>
      </el-table-column>

      <el-table-column prop="v_name" label="姓名" sortable> </el-table-column>
      ...
      <el-table-column prop="p_name" label="领取内容"> </el-table-column>
    </el-table>
    <!-- 分页 -->
...
export default {
  ...
  methods: {
    ...
    userSearch() {
      ...
      //读取商品列表
      this.$post(
        "http://www.bjytzh.cn/jxc/exchangeDetails.thtml",
