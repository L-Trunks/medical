    ...
    methods:{
        ...
        uploadImg(file) {
            ...
            this.$post('http://localhost:4000/upload',fd).then(res => {
                ...
                this.$post('http://localhost:4000/updateFace',qs.stringify(this.form)).then(res => {
                    if(res.message == 'OK') {
                        this.$message({
                            message:  "修改头像成功！",
                            type:'success'
        ...
        init(){
            ...
            this.$post('http://localhost:4000/getUserInfo',qs.stringify(this.info)).then(res => {
                console.log(res[0])
        ...
        savePassword(){
            var qs = require('qs');
            this.$post('http://localhost:4000/updatePassword',qs.stringify(this.form)).then(res => {
                if(res.message == 'OK') {
                    this.$message({
                        message:  "修改密码成功！",
                        type:'success'
