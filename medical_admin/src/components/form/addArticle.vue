<template>
    <div>
        <v-pageTitle vtitle="添加文章"></v-pageTitle>
        <div class="clear"></div>
        <el-form ref="form" label-position="right" :rules="rules" label-width="80px" :model="form">
            ...
            <el-form-item label="摘要" prop="n_abstract">
                <el-input type="textarea" maxlength="140" placeholder="最多输入140字符"  v-model="form.n_abstract"></el-input>
            </el-form-item>
            ...
            <el-form-item label="分类" prop="n_type">
                ...
                <el-option label="新闻头条" value="toutiao"></el-option>
        ...
        methods:{
            ...
            onSubmit() {
                ...
                this.$refs.form.validate((valid) => {
                    ...
                    if(valid) {
                        this.$post('http://localhost:4000/saveArticle',qs.stringify(this.form)).then(res => {
                            if(res.message == "OK") {
                                this.$message({
                                    message: "添加成功",
                                    type: 'success'
