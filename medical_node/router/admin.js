...
router.route('/showToutiaoList').post(function (req, res) {
    ...
    //console.log(name)
    let param =  [(parseInt(req.body.pageNum) - 1) * parseInt(req.body.pageSize), parseInt(req.body.pageSize)];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
...
router.route('/showToutiaoNum').post(function (req, res) {
    ...
    //console.log(name)
    //let param =  [parseInt(req.body.pageNum)-1,parseInt(req.body.pageSize)];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
...
router.route('/saveArticle').post(function (req, res) {
    ...
    //console.log(name)
    let param =  [req.body.n_img, req.body.n_title, req.body.n_abstract, req.body.n_time, req.body.n_content, req.body.n_from, req.body.n_type];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
...
router.route('/saveDoctor').post(function (req, res) {
    ...
    //console.log(name)
    let param =  [req.body.d_id, req.body.d_name, req.body.d_technicalTitle, req.body.d_committee, req.body.d_tel, req.body.d_abstract, req.body.d_face, req.body.p_houseNum, req.body.d_password];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
...
router.route('/deleteToutiaoAll').post(function (req, res) {
    ...
    //console.log(name)
    //let param =  [req.body.n_img,req.body.n_title,req.body.n_abstract,req.body.n_see_num,req.body.n_time,req.body.n_content,req.body.n_from,req.body.n_type];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
...
router.route('/updateNews').post(function (req, res) {
    ...
    //console.log(name)
    let param =  [req.body.n_img, req.body.n_title, req.body.n_abstract, req.body.n_time, req.body.n_content, req.body.n_from, req.body.n_type, req.body.n_id];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
...
router.route('/updateAddress').post(function (req, res) {
    ...
    //console.log(name)
    let param =  [req.body.d_id, req.body.d_id, req.body.id];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
...
router.route('/updateDoctor').post(function (req, res) {
    ...
    //console.log(name)
    let param =  [req.body.d_name, req.body.d_technicalTitle, req.body.d_committee, req.body.d_tel, req.body.d_abstract, req.body.d_password, req.body.d_face, req.body.p_houseNum, req.body.d_id];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
...
router.route('/updateThePhone').post(function (req, res) {
    ...
    //console.log(name)
    let param =  [req.body.title, req.body.phone, req.body.id];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
...
router.route('/updatePass').post(function (req, res) {
    ...
    //console.log(name)
    let param =  [req.body.a_password, req.body.id];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
...
router.route('/addPhone').post(function (req, res) {
    ...
    //console.log(name)
    let param =  [req.body.title, req.body.phone];
    mysql.pool.getConnection(function (error, connection) {
        if (error) {
            console.log({ message: '连接数据库失败' })
            return
