    ...
    export default {
        ...
        methods:{
            init(){
                ...
                this.$post('http://localhost:4000/getAllOrder',qs.stringify(info)).then(res => {
                    console.log(res)
                    this.tableData3 = res
            ...
            complateOrder(row){
                ...
                this.$confirm('确定已完成该预约吗？')
                    .then(_ => {
                        this.$post('http://localhost:4000/complateOrder',qs.stringify(this.map)).then(res => {
                            this.init()
                         });
                    })
                    .catch(_ => {
            ...
            delOrder(row){
                ...
                this.$confirm('确定删除该预约吗？')
                    .then(_ => {
                        this.$post('http://localhost:4000/delOrder',qs.stringify(this.map)).then(res => {
                            this.init()
                         });
                    })
                    .catch(_ => {
